...
<ul class="list-unstyled form-togglers">
    ...
    <a class="btn btn-default btn-block <?php if($form_view == 'tab_2'){ echo 'active'; } ?>" href="<?php echo $uri;?>/events/form-builder/form-fields.php?event=<?php echo $event;?>"><i class="material-icons">note</i>Form Fields</a>
    <a class="btn btn-default btn-block <?php if($form_view == 'tab_3'){ echo 'active'; } ?>" href="<?php echo $uri;?>/events/form-builder/custom-fields.php?event=<?php echo $event;?>"><i class="material-icons">note_add</i>Create Fields</a>
